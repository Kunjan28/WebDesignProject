                ...
                <Row>
                    <Col>
                        <Card>
                          ...
                          <Card.Body>
                            ...
                            <Button className="btn-post" variant="primary" href="#food">Go to Food</Button>
                          </Card.Body>
                        </Card>
                    </Col>
                    <Col>
                    <Card >
                          ...
                          <Card.Body>
                            ...
                            <Button className="btn-post" variant="primary" href="#travel">Go to Travel</Button>
                          </Card.Body>
                        </Card>
                    </Col>
                    <Col>
                    <Card >
                          ...
                          <Card.Body>
                            ...
                            <Button className="btn-post" variant="primary">Go to Blogging</Button>
                          </Card.Body>
                        </Card>
                    </Col>
                </Row>
